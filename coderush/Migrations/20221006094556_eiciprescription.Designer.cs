...
namespace coderush.Migrations
{
    ...
    [Migration("20221006094556_eiciprescription")]
    partial class eiciprescription
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("coderush.Models.Prescription", b =>
                {
            ...
            modelBuilder.Entity("coderush.Models.PrescriptionLines", b =>
                {
            ...
            modelBuilder.Entity("coderush.Models.SalesOrderLine", b =>
                {
                    ...
                    b.HasIndex("GoodsRecievedNoteLineId");
            ...
            modelBuilder.Entity("coderush.Models.ClinicalTrialsProduct", b =>
                {
                    b.HasOne("coderush.Models.ProductType", "ProductType")
                        .WithMany()
                        .HasForeignKey("ProductTypeId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("coderush.Models.UnitOfMeasure", "UnitOfMeasure")
                        .WithMany()
            ...
            modelBuilder.Entity("coderush.Models.Customer", b =>
                {
                    b.HasOne("coderush.Models.CustomerType", "customerType")
                        .WithMany()
            ...
            modelBuilder.Entity("coderush.Models.GoodsRecievedNoteLine", b =>
                {
                    ...
                    b.HasOne("coderush.Models.RFPDrugRecieve", "RFPDrugRecieve")
                        .WithMany("goodsRecievedNoteLines")
            ...
            modelBuilder.Entity("coderush.Models.PrescriptionLines", b =>
                {
                    b.HasOne("coderush.Models.Prescription")
            ...
            modelBuilder.Entity("coderush.Models.RFPDrugRecieve", b =>
                {
                    b.HasOne("coderush.Models.RFPpaymentRecieved", "RFPpaymentRecieved")
                        .WithOne("RFPDrugRecieve")
                        .HasForeignKey("coderush.Models.RFPDrugRecieve", "RFPpaymentRecievedId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("coderush.Models.RFPinvoice", b =>
                {
                    b.HasOne("coderush.Models.RFPSaleorder", "RFPSaleorder")
                        .WithOne("RFPinvoice")
                        .HasForeignKey("coderush.Models.RFPinvoice", "RFPSaleorderId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("coderush.Models.RFPpaymentRecieved", b =>
                {
                    ...
                    b.HasOne("coderush.Models.RFPinvoice", "RFPinvoice")
                        .WithOne("RFPpaymentRecieved")
                        .HasForeignKey("coderush.Models.RFPpaymentRecieved", "RFPinvoiceId")
                        .OnDelete(DeleteBehavior.Cascade);
                });

            modelBuilder.Entity("coderush.Models.RFPRequest", b =>
                {
                    b.HasOne("coderush.Models.RFPCustomer", "RFPCustomer")
                        .WithMany()
                        .HasForeignKey("RFPCustomerId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("coderush.Models.SalesOrderLine", b =>
                {
                    b.HasOne("coderush.Models.GoodsRecievedNoteLine", "GoodsRecievedNoteLine")
                        .WithMany()
                        .HasForeignKey("GoodsRecievedNoteLineId")
                        .OnDelete(DeleteBehavior.Cascade);
